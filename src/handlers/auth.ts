import { ERROR_CODES, AuthStatusInput, BeginAuthInput } from "../types.js";
...
export async function handleReconnectPackage(
...
export async function handleAuthenticateAll(
