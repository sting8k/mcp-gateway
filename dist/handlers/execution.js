...
export async function handleUseTool(input, registry, catalog, validator) {
...
export async function handleMultiUseTool(input, context) {
...
export function extractUseToolPayload(response) {
...
export function normalizeMultiToolError(error) {
    if (error instanceof ValidationError) {
        return {
            code: error.code,
...
export function createMultiToolTimeoutResult(request) {
    return {
        status: "error",
        request_id: request.request_id,
        package_id: request.package_id,
